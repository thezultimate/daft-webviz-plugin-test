...
# This file was generated by DAFT on 2020-10-12 with Python executable
...
app.title = "Test of some custom containers"
...
if False and not webviz_config.is_reload_process():
    ...
    page_content["front-page"] = [
       dcc.Markdown(r"""This is a `webviz` instance created from a configuration file."""),
    ...
    page_content["azure-code-flow-test"] = [
       standard_plugins.SomeRadixDaftPlugin(app=app, **{}).plugin_layout(contact_person=None)
       ]
    ...
    app.layout = html.Div(
        ...
        html.Div(
            ...
            children=[
                ...
                dcc.Link("Azure code flow test",
                    # We will create a webviz-core-components
                    # component instead of styling dcc.Link's,
                    # then we can more easily change className to
                    # selectedButton for current page.
                    className="styledButton",
                    id="azure-code-flow-test",
                    href="/azure-code-flow-test",)
            ])]),
